...
const Osh = () => {
  ...
  async function addRegions() {
    let res = await axios(`http://13.60.97.160/${language}/region/2/`);
    let { data } = res;
    setRegions(data);
  }
        ...
        <div className="osh">
          ...
          <div className="slick">
            ...
            {active === 2 && (
              <div className="slick--block">
                <p>
                  <span>{mealres[1]?.meal_name}</span> <br />
                  {mealres[1]?.description.slice(0, 500)}
                </p>
                <div className="slick--block__pagination">
                  <img
                    src={mealres[1]?.meal_image1}
                    alt="img"
                    className="imgG"
                  />
                  <div className="slick--block__pagination--images">
                    <img src={mealres[1]?.meal_image1} alt="img" width={100} />
                    <img src={mealres[1]?.meal_image3} alt="img" width={100} />
                    <img src={mealres[1]?.meal_image2} alt="img" width={100} />
                  </div>
                </div>
                <p>{mealres[0]?.description.slice(0, 500)}</p>
              </div>
            ...
            {active === 3 && (
              <div className="slick--block">
                <p>
                  <span>{mealres[2]?.meal_name}</span> <br />
                  {mealres[2]?.description.slice(0, 500)}
                </p>
                <div className="slick--block__pagination">
                  <img
                    src={mealres[2]?.meal_image1}
                    alt="img"
                    className="imgG"
                  />
                  <div className="slick--block__pagination--images">
                    <img src={mealres[2]?.meal_image1} alt="img" width={100} />
                    <img src={mealres[2]?.meal_image3} alt="img" width={100} />
                    <img src={mealres[2]?.meal_image2} alt="img" width={100} />
                  </div>
                </div>
                <p>{mealres[0]?.description.slice(0, 500)}</p>
              </div>
